...
export function SignUpScreen() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await localSignUp({ name, email });
      // onboarding keyin: hozircha dashboard
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-neutral-300">Local mode for now.</p>
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        ...
        <p className="text-center text-sm text-neutral-300">
          ...
          <Link className="text-fuchsia-200 hover:underline" href="/sign-in">
            Sign in
          </Link>
        </p>
      </form>
